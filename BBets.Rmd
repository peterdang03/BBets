...
### What I am going to do is to run the BrLw function  a 1000 different times, and each time I run it, I'm capturing the number that represents how much Brownlow will make. Then I will sort these numbers from low to high, and grab the lower two and a half percent.
